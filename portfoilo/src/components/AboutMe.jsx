...
const AboutMe = () => {
    return (
        <div className='aboutMeSection'>
            ...
            <p className='Passage1'>I’m a passionate Navy Veteran trained in both full stack development and UX/UI design.<br/><br/>
              ...
              Through that experience, I discovered I wanted to contribute to making this world a better place.<br/><br/>
